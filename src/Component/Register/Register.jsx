...
const Register = () => {
  ...
  const[showPassword, setShowpassword] = useState(false)
    ...
    return (
        <div className="relative my-16 flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
        ...
        <form  onSubmit={handleRegister} className="mt-8 mx-auto mb-2 w-80 max-w-screen-lg sm:w-96">
          <div className="mb-4 flex flex-col gap-6">
            ...
            <div className="relative mb-8 h-11 w-full min-w-[200px]">
              ...
              <span className='absolute left-80 my-4' onClick={() => setShowpassword(!showPassword)
              }> {
